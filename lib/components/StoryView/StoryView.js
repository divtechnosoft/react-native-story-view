...
const StoryView = (props) => {
    ...
    return (React.createElement(View, { style: [styles.divStory, { height, width }], ref: props === null || props === void 0 ? void 0 : props.viewRef },
        React.createElement(View, { style: [
            ...
            (loading || buffering) && (props === null || props === void 0 ? void 0 : props.showSourceIndicator) && (React.createElement(ActivityIndicator, { animating: true, pointerEvents: "none", color: "#ffff", size: "small", style: styles.loaderView, ...props === null || props === void 0 ? void 0 : props.sourceIndicatorProps }))))))));
};
